...
通过 `~/alpha_projects/.agents/skills/fund-qr-deploy/deploy_fund_qr_to_xinjiang.sh` 把 fund-qr
...
+ 研究员 `$aef-alpha-onboard` 会自动纳入 fund-qr MCP**（onboard 逐 server 探测 import，之前因 `fund_qr`
