...
你负责的因子任务文档（逐条实现）：
- `/home/cken/hft_projects/HFTPool/factor_agent_docs/FactorAgent{i}_*.md`
...
- 任何定义冲突：先查 `research_docs` 与 `FactorAgent{i}_*.md`，仍不确定再提出“具体冲突点 + 文件位置 + 你建议的两套口径”，并默认先按文档原定义实现一版。
